                ...
                <div class="grid-container">
                    ...
                    <div class="grid-row">
                        ...
                        <div class="grid-md-5 grid-lg-5">
                            <img src="<?php echo get_template_directory_uri() . '/screenshot.png';?>" alt="<?php esc_html_e( 'profisme', 'profisme' ); ?>" />
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="cwp-intro-auth">
                                <div class="cwp-card">
                                    <div class="cwp-intro-profile">
                                        <span>
                                            <img class="profisme-gsm-screenshot" src="<?php echo esc_url(get_template_directory_uri() .'/assets/images/logo.png' )?>" alt="<?php esc_html_e( 'profisme', 'profisme' ); ?>" />
                                        </span>
                                    </div>
