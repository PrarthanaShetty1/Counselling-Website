		...
		if ( simclick_is_slider_displayed() ) {
			...
			$output .= '
							<div class="controllers">
								<!-- prev/next links -->
								<div id="featured-slider-prev" class="cycle-prev fa fa-angle-left" aria-label="' . esc_html__( 'Previous Slide', 'simclick'  ) . '" aria-hidden="true"><span class="screen-reader-text">' . esc_html__( 'Previous Slide', 'simclick'  ) . '</span></div>

								<!-- empty element for pager links -->
								<div id="featured-slider-pager" class="cycle-pager"></div>

								<div id="featured-slider-next" class="cycle-next fa fa-angle-right" aria-label="' . esc_html__( 'Next Slide', 'simclick'  ) . '" aria-hidden="true"><span class="screen-reader-text">' . esc_html__( 'Next Slide', 'simclick'  ) . '</span></div>
